    ...
    def pure_parse_daily_index(self, all_idx_url):
        ...
        for idx_url in all_idx_url:
            ...
            for filing in filings:
                ...
                self.logger.info(f"[[{idx_url.split('/')[-1].split('.')[1]}]]{filing['company_name']} has {filing['form_type']} filed in {filing['date_filed']}")
...
if __name__ == "__main__":
    ...
    downloader.download_year_range(2009,2009)
