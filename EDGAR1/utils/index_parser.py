...
if __name__ == "__main__":
    url = "https://www.sec.gov/Archives/edgar/data/1144879/000162828025017684/0001628280-25-017684-index.htm"
    ...
    print(str(Path(result["documentFormatFiles"]["EX-31.1"]["doc"]).parent))
